...
* Task 2.3, produces incorrect results; -2
    * The value equation should use `sum(!is.na(margs))` instead of `length(margs)`
* Lines 377, 392: fails to run because of bug; -2
    * use `names(league)` instead of `names(l)`
* Extremely well done!
