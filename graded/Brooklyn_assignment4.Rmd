...
## Your template was an old version from Cole- he updated the points per question
## since you downloaded it, so no bonus, but you didn't need it ;)
...
## Question 3:
## for part 2, should be x2 where you have x1
sum((which(x2[,'pos']=='wr') <= 40))
