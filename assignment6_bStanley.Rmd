...
for (i in 2:9){
  ...
  hist(poptemp$m, main=paste("Male Height in Generation",i), breaks=9)
...
plot.medicalRecord <- function(patient) {
  par(mfrow=c(1,3))
  plot(patient$date_of_admission,patient$temperature,type='b', xaxt='n',col='red',
       xlab="Date of Admission", ylab = "Temperature")
  axis(1, at=patient$date_of_admission,labels=patient$date_of_admission)
  plot(patient$date_of_admission,patient$pulse,type='b', xaxt='n',col="green",
       ylab = "Pulse", xlab= "Date of Admission")
  axis(1, at=patient$date_of_admission,labels=patient$date_of_admission)
  plot(patient$date_of_admission,patient$fluid_intake,type='b', xaxt='n',col="blue",
